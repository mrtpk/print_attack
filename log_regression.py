...
if __name__ == "__main__":
    ...
    path_save_model = "./data/models/logistic_regression/{}.joblib"
    ...
    dump(clf, path_save_model.format("logistic_regression"))
    clf_load = load(path_save_model.format("logistic_regression"))
    y_pred = clf.predict(x_test)
    print("Accuracy:",metrics.accuracy_score(y_test, y_pred))